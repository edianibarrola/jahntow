...
# imports models. Entries with a "title" grant a display title shown on
# the leaderboard; a later-earned title replaces an earlier one.
ACHIEVEMENTS = [
    {'id': 'level-5', 'name': 'Finding Your Feet', 'desc': 'Reach level 5',
     'metric': 'level', 'threshold': 5},
    {'id': 'level-15', 'name': 'Seasoned Spacer', 'desc': 'Reach level 15',
     'metric': 'level', 'threshold': 15},
    {'id': 'level-30', 'name': 'Galactic Operator', 'desc': 'Reach level 30',
     'metric': 'level', 'threshold': 30},
    {'id': 'level-50', 'name': 'Veteran of the Void', 'desc': 'Reach level 50',
     'metric': 'level', 'threshold': 50, 'title': 'Veteran'},
    {'id': 'prestige-1', 'name': 'Born Again', 'desc': 'Prestige for the first time',
     'metric': 'prestige', 'threshold': 1, 'title': 'Reborn'},
    {'id': 'prestige-3', 'name': 'Eternal Cycle', 'desc': 'Prestige three times',
     'metric': 'prestige', 'threshold': 3},
    {'id': 'story-25', 'name': 'First Steps to Freedom', 'desc': 'Reach 25 story wins',
     'metric': 'storyWins', 'threshold': 25},
    {'id': 'story-105', 'name': 'Halfway Across the Stars', 'desc': 'Reach 105 story wins',
     'metric': 'storyWins', 'threshold': 105},
    {'id': 'story-210', 'name': 'Liberator of the Tribes', 'desc': 'Complete the story',
     'metric': 'storyWins', 'threshold': 210, 'title': 'Liberator'},
    {'id': 'wins-10', 'name': 'Proven Contractor', 'desc': 'Win 10 missions',
     'metric': 'stat:missions_won', 'threshold': 10},
    {'id': 'wins-100', 'name': 'Mission Specialist', 'desc': 'Win 100 missions',
     'metric': 'stat:missions_won', 'threshold': 100},
    {'id': 'wins-500', 'name': 'Legend of the Lanes', 'desc': 'Win 500 missions',
     'metric': 'stat:missions_won', 'threshold': 500, 'title': 'Legend'},
    {'id': 'sold-50', 'name': 'Market Regular', 'desc': 'Sell 50 items',
     'metric': 'stat:items_sold', 'threshold': 50},
    {'id': 'sold-500', 'name': 'Trade Baron', 'desc': 'Sell 500 items',
     'metric': 'stat:items_sold', 'threshold': 500},
    {'id': 'streak-5', 'name': 'On a Roll', 'desc': 'Reach a 5-mission win streak',
     'metric': 'stat:best_win_streak', 'threshold': 5},
    {'id': 'streak-10', 'name': 'Untouchable', 'desc': 'Reach a 10-mission win streak',
     'metric': 'stat:best_win_streak', 'threshold': 10},
    {'id': 'props-5', 'name': 'Landholder', 'desc': 'Own 5 properties',
     'metric': 'properties_owned', 'threshold': 5},
    {'id': 'props-15', 'name': 'Portfolio Manager', 'desc': 'Own 15 properties',
     'metric': 'properties_owned', 'threshold': 15},
    {'id': 'props-36', 'name': 'Empire of Deeds', 'desc': 'Own every property',
     'metric': 'properties_owned', 'threshold': 36},
    {'id': 'credits-100k', 'name': 'Six Figures', 'desc': 'Hold 100,000 credits',
